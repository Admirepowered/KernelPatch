...
/* Executable-memory allocators. module_alloc exists up to ~6.8 and is replaced
 * by execmem_alloc() in 6.10+ (EXECMEM_MODULE_TEXT); vmalloc is the universal
 * last resort (still needs set_memory_x to be executable on arm64). */
